...
fun Entity.addLayer(ordinal:com.darkoverlordofdata.entitas.test.Layer):Entity {
...
fun Entity.replaceLayer(ordinal:com.darkoverlordofdata.entitas.test.Layer):Entity {
...
fun Entity.addSoundEffect(effect:com.darkoverlordofdata.entitas.test.Effect):Entity {
...
fun Entity.replaceSoundEffect(effect:com.darkoverlordofdata.entitas.test.Effect):Entity {
...
fun Entity.addView(sprite:Any):Entity {
...
fun Entity.replaceView(sprite:Any):Entity {
